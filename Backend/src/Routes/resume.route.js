...
import { createResume, deleteResume, generateResumePdf, getAllResumes, getResumesId, saveResumeData } from "../Controllers/resume.controller.js";
import { upload } from "../Middleware/multer.js";
const router = Router()

router.route("/save").post(verifyJWT,upload.single( "profileImage" ),saveResumeData)
